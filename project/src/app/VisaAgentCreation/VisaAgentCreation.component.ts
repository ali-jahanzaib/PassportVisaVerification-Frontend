...
@Component({
  selector: 'app-visaagenntcreation',
  templateUrl: './VisaAgentCreation.component.html',
  styleUrls: ['./VisaAgentCreation.component.css']
})
export class VisaAgentCreationComponent implements OnInit{
  ...
  async submit(){
    ...
    let endpoint=`${environment.API_ENDPOINT}/${environment.PORTAL}/api/saveVisaAgentData`;
