...
@Component({
  selector: 'app-passportofficercreation',
  templateUrl: './PassportOfficerCreation.component.html',
  styleUrls: ['./PassportOfficerCreation.component.css']
})
export class PassportOfficerCreationComponent implements OnInit{
  ...
  async submit(){
    ...
    let endpoint=`${environment.API_ENDPOINT}/${environment.PORTAL}/api/savePassportOfficerData`;

   this.commonService.postData(endpoint, this.payload, true).subscribe(res=>{
     console.log(res);

     this.bodyText = 'New Passport Officer added successfully.'
