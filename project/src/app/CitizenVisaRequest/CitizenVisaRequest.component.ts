...
@Component({
  selector: 'app-citizenvisarequest',
  templateUrl: './CitizenVisaRequest.component.html',
  styleUrls: ['./CitizenVisaRequest.component.css']
})
export class CitizenVisaRequestComponent {
  ...
  submit(){
    ...
    let endpoint=`${environment.API_ENDPOINT}/${environment.PORTAL}/api/findAllPvCitizenPassportForVisaWithCitizen/`+ this.userDetails.identityNo;
