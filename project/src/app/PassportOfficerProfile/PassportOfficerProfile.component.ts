...
@Component({
  selector: 'app-passportofficerprofile',
  templateUrl: './PassportOfficerProfile.component.html',
  styleUrls: ['./PassportOfficerProfile.component.css']
})
export class PassportOfficerProfileComponent implements OnInit{
